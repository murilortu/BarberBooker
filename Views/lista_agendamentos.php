          ...
          <tbody>
            <?php foreach ($agendamentos as $agendamento): ?>
              <tr>
                ...
                <td><a href="./editar.php?id=<?php echo htmlspecialchars($agendamento['id_agendamento']); ?>">Editar</a></td>
                <td><a href="./delete.php?id=<?php echo htmlspecialchars($agendamento['id_agendamento']); ?>">Deletar</a></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
